...
const Steps = () => {
  return (
    <div class="p-8">
      <div class="bg-white p-4 rounded-lg py-8 -mt-6">
        <div class="space-y-12 px-2 xl:px-16 mt-12">
          <div class="mt-4 flex">
            <div>
              <div class="flex items-center h-16 border-l-4 border-blue-600">
                <span class="text-4xl text-blue-600 px-4">1.</span>
              </div>
              <div class="flex items-center h-16 border-l-4 border-gray-400"></div>
            </div>
            <div>
          ...
          <div class="mt-4 flex">
            <div>
              <div class="flex items-center h-16 border-l-4 border-blue-600">
                <span class="text-4xl text-blue-600 px-4">2.</span>
              </div>
              <div class="flex items-center h-16 border-l-4 border-gray-400"></div>
            </div>
            <div>
          ...
          <div class="mt-4 flex">
            <div>
              <div class="flex items-center h-16 border-l-4 border-blue-600">
                <span class="text-4xl text-blue-600 px-4">3.</span>
              </div>
              <div class="flex items-center h-16 border-l-4 border-gray-400"></div>
            </div>
            <div>
          ...
          <div class="mt-4 flex">
            <div>
              <div class="flex items-center h-16 border-l-4 border-blue-600">
                <span class="text-4xl text-blue-600 px-4">4.</span>
              </div>
              <div class="flex items-center h-16 border-l-4 border-gray-400"></div>
            </div>
            <div>
              <div class="flex items-center h-22 sm:h-16">
                <span class="text-lg text-blue-600 font-bold">
